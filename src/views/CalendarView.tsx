...
export const CalendarView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Top Header & Controls */}
      <div className="duo-card flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-5 border-2 border-stone-200 dark:border-slate-800">
        
        {/* Navigation title */}
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-blue-100 dark:bg-blue-950/80 text-blue-600 dark:text-blue-300 flex items-center justify-center font-bold">
            <CalendarIcon className="w-5 h-5" />
          </div>
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-xl font-black text-stone-900 dark:text-white capitalize">
                {format(currentDate, 'MMMM yyyy', { locale: de })}
              </h2>
              <button
                onClick={goToToday}
                className="px-2.5 py-0.5 text-xs font-bold rounded-lg bg-stone-100 dark:bg-slate-800 hover:bg-stone-200 dark:hover:bg-slate-700 text-stone-700 dark:text-slate-200 transition-colors"
              >
                Heute
              </button>
            </div>
            <p className="text-xs font-semibold text-stone-500 dark:text-slate-400">
              Koordination von {members.length} Familienmitgliedern
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center flex-wrap gap-2">
          ...
          <button
            ...
            className="duo-btn duo-btn-blue px-3.5 py-2 text-xs font-black rounded-xl shadow-xs"
          >
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-stone-50/80 dark:bg-slate-800/80 p-3.5 rounded-2xl border border-stone-200/70 dark:border-slate-700">
